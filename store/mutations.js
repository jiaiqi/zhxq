...
const state = {
	openid: null,
	wxUserInfo: uni.getStorageSync('wxUserInfo') || {}, // 微信用户信息
	staffInfo: {}, //工作人员信息
	villageInfo:{}, //村信息
	roleInfo:{},
	...
	login_user_info: uni.getStorageSync('login_user_info') || null, // 登录用户信息 Object
...
const mutations = {
	SET_WX_USERINFO(state, data) {
		state.wxUserInfo = data
	},
	SET_STAFF_INFO(state, data) {
		state.staffInfo = data
	},
	SET_VILLIAGE_INFO(state,data){
		state.villageInfo = data
	},
	...
	setLoginUser(state, login_user_info) {
